...
**Линией уровня** функции двух переменных называется линия (множество точек) на координатной плоскости, в которых функция принимает одинаковые значения. Перед нами стоит задача построить линии уровня, когда даны *ковариационная матрица нормального распределения* и *мат ожидание*. 

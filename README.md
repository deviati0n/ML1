...
| λ = (5, 1) | λ = (1, 3) |
 ...
 Для примера, два класса имеют одинаковые параметры. Видно, что **Plpug-in** не смогу отрисовать карту классификации, т.к. *sigma* для каждого класса - вырождены. 
...
***Градиентные методы** - это широкий класс оптмизационных алгоритмов, которые используются не только в машинном обучении. В данном случае метод стохастического градиента будет использоваться для нахождения синаптических весов **w**, при этом будет достигаться минимум апроксимированного эмпирического риска:
https://user-images.githubusercontent.com/71149650/100413373-38b4f180-3088-11eb-9096-75fd371bcebc.png

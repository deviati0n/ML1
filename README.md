...
<a href="https://www.codecogs.com/eqnedit.php?latex=\sigma_{11}x^2&space;&plus;&space;\sigma_{22}y^2&space;&plus;&space;(\sigma_{12}&space;&plus;&space;\sigma_{21})xy&space;&plus;&space;(-(\sigma_{12}&space;&plus;&space;\sigma_{21})\mu_2&space;-&space;2\sigma_{11}\mu_1)x&space;&plus;&space;(-(\sigma_{12}&space;&plus;&space;\sigma_{21})\mu_1&space;-&space;2\sigma_{22}\mu_2)y&space;&plus;&space;\sigma_{11}\mu_1^2&space;&plus;&space;\sigma_{22}\mu_2^2&space;&plus;&space;(\sigma_{12}&space;&plus;&space;\sigma_{21})\mu_1&space;&plus;&space;\mu_2&space;&plus;&space;2\ln2\pi&space;N&space;\sqrt{\sigma_{11}\sigma_{22}&space;-&space;\sigma_{12}\sigma_{21}}&space;=&space;0" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\sigma_{11}x^2&space;&plus;&space;\sigma_{22}y^2&space;&plus;&space;(\sigma_{12}&space;&plus;&space;\sigma_{21})xy&space;&plus;&space;(-(\sigma_{12}&space;&plus;&space;\sigma_{21})\mu_2&space;-&space;2\sigma_{11}\mu_1)x&space;&plus;&space;(-(\sigma_{12}&space;&plus;&space;\sigma_{21})\mu_1&space;-&space;2\sigma_{22}\mu_2)y&space;&plus;&space;\sigma_{11}\mu_1^2&space;&plus;&space;\sigma_{22}\mu_2^2&space;&plus;&space;(\sigma_{12}&space;&plus;&space;\sigma_{21})\mu_1&space;&plus;&space;\mu_2&space;&plus;&space;2\ln2\pi&space;N&space;\sqrt{\sigma_{11}\sigma_{22}&space;-&space;\sigma_{12}\sigma_{21}}&space;=&space;0" title="\sigma_{11}x^2 + \sigma_{22}y^2 + (\sigma_{12} + \sigma_{21})xy + (-(\sigma_{12} + \sigma_{21})\mu_2 - 2\sigma_{11}\mu_1)x + (-(\sigma_{12} + \sigma_{21})\mu_1 - 2\sigma_{22}\mu_2)y + \sigma_{11}\mu_1^2 + \sigma_{22}\mu_2^2 + (\sigma_{12} + \sigma_{21})\mu_1 + \mu_2 + 2\ln2\pi N \sqrt{\sigma_{11}\sigma_{22} - \sigma_{12}\sigma_{21}} = 0" /></a>

Вывод формулы в конспекте [тут](https://github.com/deviati0n/ML1/issues/1#issuecomment-749414532)

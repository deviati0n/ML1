...
| λ = (5, 1) | λ = (1, 3) |
 ...
 ### ЛДФ и Plug-in ###
  ...
  Если выборка имеет небольшое кол-во элементов, то **ЛДФ** будет иметь более качественный результат работы, чем **Plug-in**. Еще одним плюсом **ЛДФ** есть то, что в нем не надо считатать квадраты, а следовательно будет потрачено меньше ресурсов. В то же время **Plug-in** более универсален, ведь именно за счет тех самых квадртатов, он может огибать точки классов, которые **ЛДФ** мог бы просто откинуть. 

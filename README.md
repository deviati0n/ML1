...
Метод схож с парзеновским окном, при этом у каждой точки выборки будет свой потенциал. Этот потенциал будет учитываться при подсчете веса точки выборки(умножать на значение ядерной функции)

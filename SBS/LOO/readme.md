...
+ по параметру метода - **Парзеновское окно**

Таким образом, если главное при выполнении задачи - минимазация ошибок, то лучше выбрать **KNN**, если же скорость работы - **Парзеновское окно**.
